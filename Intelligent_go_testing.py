...
benchmark_data = [
    {"text": "The Israeli settlements in the West Bank are essential for Israel's security.",
    ...
    {"text": "The occupation of Palestinian territories is a violation of international law.",
    ...
    {"text": "The international community should impose sanctions on Israel for its actions.",
     "ideology": "Pro-Palestine"},
    ...
    {"text": "Palestinian protests against the occupation are a form of civil resistance.",
     "ideology": "Pro-Palestine"},
    ...
    {"text": "Israel's partnerships with neighboring countries are key to regional stability.",
     "ideology": "Pro-Israeli"},
...
model = BertForSequenceClassification.from_pretrained(model_name,
                                                      num_labels=3)  # 3 ideologies: Pro-Israeli, Pro-Palestine, Neutral
...
for epoch in range(epochs):
    ...
    for i, text in enumerate(corpus):
        logits, predicted_class_id, ideology_label, alignment_prob = identify_ideology_bert(text)
        ...
        print(
            f"Epoch {epoch + 1}/{epochs}, Text: {text[:50]}, Predicted Ideology: {ideology_label}, Alignment Probability: {alignment_prob}")
...
def evaluate_benchmark_from_csv(csv_file_path):
    with open(csv_file_path, mode='r') as file:
        ...
        for row in reader:
            ...
            _, _, predicted_ideology, alignment_prob = identify_ideology_bert(text)
            print(f"Text: {text}")
            print(f"Expected Ideology: {expected_ideology}")
            print(f"Predicted Ideology: {predicted_ideology}")
            print(f"Alignment Probability: {alignment_prob}")
...
if __name__ == "__main__":
    ...
    _, _, ideology, alignment_prob = identify_ideology_bert(text)
